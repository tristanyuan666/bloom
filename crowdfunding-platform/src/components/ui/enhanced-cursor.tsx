    ...
    <>
      ...
      <div
        className={cn(
          ...
          "w-8 h-8 rounded-full border-2 border-[#56D08D]/80 bg-[#56D08D]/10",
          "backdrop-blur-sm shadow-lg shadow-[#56D08D]/30",
          "transform -translate-x-1/2 -translate-y-1/2",
          isVisible ? "opacity-100 visible" : "opacity-0 invisible",
          isHovering && "scale-150 border-[#56D08D] bg-[#56D08D]/20 shadow-[#56D08D]/50",
          isClicking && "scale-75",
          className,
        )}
        style={{
      ...
      <div
        className={cn(
          ...
          "w-2 h-2 rounded-full bg-[#56D08D]/60",
          "transform -translate-x-1/2 -translate-y-1/2",
          isVisible ? "opacity-100 visible" : "opacity-0 invisible",
          isHovering && "scale-150 bg-[#56D08D]/80",
          isClicking && "scale-50",
        )}
        style={{
          left: `${position.x}px`,
